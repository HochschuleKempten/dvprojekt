...
void VUI::initUI(HWND hwnd, CSplash* psplash)
{
	...
	//get computer name
	std::vector<const char*> computerNameBlacklist{ "TITANIC-TABLET", "TITANIC-MOBIL","FRAMECATCHER-PC", "IVO-NOTEBOOK" };	//Opt-in when you want to compile the shaders at every start
