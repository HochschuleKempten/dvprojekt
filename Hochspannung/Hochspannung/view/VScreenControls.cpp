...
VScreenControls::VScreenControls(VUI* vUi) : IViewScreen(vUi)
{
	...
	m_background->InitFull("textures/gui/background/ingame_options_controls.png");
...
VScreenControls::~VScreenControls()
{
	delete m_background;
}

void VScreenControls::onNotify(const Event& events)
{
	switch (events)
	{
	default:
...
void VScreenControls::checkShortcut(CDeviceKeyboard* keyboard)
{
...
void VScreenControls::checkSpecialEvent(CDeviceCursor* cursor)
{
}


void VScreenControls::tick(const float fTimeDelta)
{
...
void VScreenControls::checkGUIObjects(IViewGUIContainer* tempGuicontainer)
{
...
void VScreenControls::checkGUIContainer(IViewGUIContainer* tempGuicontainer)
{
...
void VScreenControls::startAnimation()
{
}

void VScreenControls::StartEvent()
{
}

void VScreenControls::EndEvent()
{
}

void VScreenControls::resize(const int width, const int height)
{
}
