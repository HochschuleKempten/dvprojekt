...
{
public:
	VGroup(CViewport* viewport, CFloatRect floatRect, const std::string& sName);
	VGroup(CViewport* viewport, CFloatRect floatRect, CMaterial* materialbackground, const std::string& sName);
	VGroup();
	~VGroup();
