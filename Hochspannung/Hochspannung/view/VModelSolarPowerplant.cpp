...
VModelSolarPowerPlant::VModelSolarPowerPlant()
{
	...
	m_zgStabilisierung.Init(CHVector(1.8, 0.05, 0.1), &m_zm);

	m_zgSenkrechte.Init(0.2, 0.2, 1.08, &m_zm);
	m_zgGrundflaeche.Init(CHVector(2, 0.05, 1.5), &m_zm);
	m_zgSockel.Init(CHVector(1, 0.05, 1), &m_zm);
	m_zgFoundation.Init(CHVector(1, 0.05, 1), &m_zm);
