...
VModelSolarPowerPlant::VModelSolarPowerPlant()
{
	...
	m_zgStabilisierung.Init(CHVector(1.8, 0.05, 0.1), &m_zmSolarFlaeche);

	m_zgSenkrechte.Init(0.2, 0.2, 1.08, &m_zmSolarFlaeche);
	m_zgGrundflaeche.Init(CHVector(2, 0.05, 1.5), &m_zmSolarFlaeche);
	m_zgSockel.Init(CHVector(1, 0.05, 1), &m_zmSolarFlaeche);
	m_zgSolarzelle1.Init(CHVector(0.3, 0.05, 0.2), &m_zmSolar);
	m_zgSolarzelle2.Init(CHVector(0.3, 0.05, 0.2), &m_zmSolar);
	m_zgSolarzelle3.Init(CHVector(0.3, 0.05, 0.2), &m_zmSolar);
	m_zgSolarzelle4.Init(CHVector(0.3, 0.05, 0.2), &m_zmSolar);
	m_zgSolarzelle5.Init(CHVector(0.3, 0.05, 0.2), &m_zmSolar);
	m_zgSolarzelle6.Init(CHVector(0.3, 0.05, 0.2), &m_zmSolar);
	m_zgSolarzelle7.Init(CHVector(0.3, 0.05, 0.2), &m_zmSolar);
	m_zgSolarzelle8.Init(CHVector(0.3, 0.05, 0.2), &m_zmSolar);
	m_zgSolarzelle9.Init(CHVector(0.3, 0.05, 0.2), &m_zmSolar);
	m_zgSolarzelle10.Init(CHVector(0.3, 0.05, 0.2), &m_zmSolar);
	m_zgSolarzelle11.Init(CHVector(0.3, 0.05, 0.2), &m_zmSolar);
	m_zgSolarzelle12.Init(CHVector(0.3, 0.05, 0.2), &m_zmSolar);
	m_zgSolarzelle13.Init(CHVector(0.3, 0.05, 0.2), &m_zmSolar);
	m_zgSolarzelle14.Init(CHVector(0.3, 0.05, 0.2), &m_zmSolar);
	m_zgSolarzelle15.Init(CHVector(0.3, 0.05, 0.2), &m_zmSolar);
	m_zgSolarzelle16.Init(CHVector(0.3, 0.05, 0.2), &m_zmSolar);
	m_zgSolarzelle17.Init(CHVector(0.3, 0.05, 0.2), &m_zmSolar);
	m_zgSolarzelle18.Init(CHVector(0.3, 0.05, 0.2), &m_zmSolar);
	m_zgSolarzelle19.Init(CHVector(0.3, 0.05, 0.2), &m_zmSolar);
	m_zgSolarzelle20.Init(CHVector(0.3, 0.05, 0.2), &m_zmSolar);
	m_zgSolarzelle21.Init(CHVector(0.3, 0.05, 0.2), &m_zmSolar);
	m_zgSolarzelle22.Init(CHVector(0.3, 0.05, 0.2), &m_zmSolar);
	m_zgSolarzelle23.Init(CHVector(0.3, 0.05, 0.2), &m_zmSolar);
	m_zgSolarzelle24.Init(CHVector(0.3, 0.05, 0.2), &m_zmSolar);
	m_zgSolarzelle25.Init(CHVector(0.3, 0.05, 0.2), &m_zmSolar);
	m_zgSolarzelle26.Init(CHVector(0.3, 0.05, 0.2), &m_zmSolar);
	m_zgSolarzelle27.Init(CHVector(0.3, 0.05, 0.2), &m_zmSolar);
	m_zgSolarzelle28.Init(CHVector(0.3, 0.05, 0.2), &m_zmSolar);
	m_zgSolarzelle29.Init(CHVector(0.3, 0.05, 0.2), &m_zmSolar);
	m_zgSolarzelle30.Init(CHVector(0.3, 0.05, 0.2), &m_zmSolar);
	m_zgSolarzelle31.Init(CHVector(0.3, 0.05, 0.2), &m_zmSolar);
	m_zgSolarzelle32.Init(CHVector(0.3, 0.05, 0.2), &m_zmSolar);
	m_zgSolarzelle33.Init(CHVector(0.3, 0.05, 0.2), &m_zmSolar);
	m_zgSolarzelle34.Init(CHVector(0.3, 0.05, 0.2), &m_zmSolar);
	m_zgSolarzelle35.Init(CHVector(0.3, 0.05, 0.2), &m_zmSolar);
	m_zgSolarzelle36.Init(CHVector(0.3, 0.05, 0.2), &m_zmSolar);
	m_zgSolarzelle37.Init(CHVector(0.3, 0.05, 0.2), &m_zmSolar);
	m_zgSolarzelle38.Init(CHVector(0.3, 0.05, 0.2), &m_zmSolar);
	m_zgSolarzelle39.Init(CHVector(0.3, 0.05, 0.2), &m_zmSolar);
	m_zgSolarzelle40.Init(CHVector(0.3, 0.05, 0.2), &m_zmSolar);
	m_zgSolarzelle41.Init(CHVector(0.3, 0.05, 0.2), &m_zmSolar);
	m_zgSolarzelle42.Init(CHVector(0.3, 0.05, 0.2), &m_zmSolar);
