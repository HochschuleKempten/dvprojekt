...
VModelNuclearPowerPlant::VModelNuclearPowerPlant()
{
	...
	m_zpKuehlturm1.Translate(-2.0f, 0.15f, -2.0f);
	m_zpKuehlturm1.AddGeo(&m_zgKuehlturm);

	m_zpKuehlturm2.Translate(2.0f, 0.15f, -2.0f);
	m_zpKuehlturm2.AddGeo(&m_zgKuehlturm);

	m_zpReaktorTurm1.Translate(-0.9f, 0.85f, 3.0f);
	m_zpReaktorTurm1.AddGeo(&m_zgReaktorTurm);

	m_zpReaktorKopf1.Translate(-0.9f, 1.45f, 3.0f);
	m_zpReaktorKopf1.AddGeo(&m_zgReaktorKopf);

	m_zpReaktorTurm2.Translate(0.9f, 0.85f, 3.0f);
	m_zpReaktorTurm2.AddGeo(&m_zgReaktorTurm);

	m_zpReaktorKopf2.Translate(0.9f, 1.45f, 3.0f);
	m_zpReaktorKopf2.AddGeo(&m_zgReaktorKopf);

	m_zpKamin.Translate(0.0f, 2.15f, 2.0f);
	m_zpKamin.AddGeo(&m_zgKamin);

	m_zpGebaeude1.Translate(0.0f, 0.15f, -0.7f);
	m_zpGebaeudeHaelfte11.Translate(1.0f, 0.15f, 2.0f);
	m_zpGebaeudeHaelfte12.TranslateDelta(-1.0f, 0.15f, -1.0f);
	m_zpGebaeudeHaelfte12.RotateYDelta(PI);

	m_zpGebaeude2.Translate(-2.8f, 0.15f, -3.8f);
	m_zpGebaeude2.RotateYDelta(0.5 * PI);
	m_zpGebaeudeHaelfte21.Translate(1.0f, 0.15f, 1.6f);
	m_zpGebaeudeHaelfte22.TranslateDelta(-1.0f, 0.15f, -0.6f);
	m_zpGebaeudeHaelfte22.RotateYDelta(PI);

	m_zTrasse1->getMainPlacement()->Translate(3.0f, 0.35f, 2.0f);
	m_zTrasse2->getMainPlacement()->Translate(3.0f, 0.35f, 3.5f);

	m_zpPfosten1.Translate(-1.6f, 0.15f, 4.8f);
	m_zpPfosten1.AddGeo(&m_zgPfosten);
	m_zpPfosten2.Translate(-5.0f, 0.15f, 4.8f);
	m_zpPfosten2.AddGeo(&m_zgPfosten);
	m_zpPfosten2.Translate(-5.0f, 0.15f, 4.8f);
	m_zpPfosten2.AddGeo(&m_zgPfosten);
	m_zpPfosten2.Translate(-5.0f, 0.15f, 4.8f);
	m_zpPfosten2.AddGeo(&m_zgPfosten);
	m_zpPfosten3.Translate(-5.0f, 0.15f, -0.1f);
	m_zpPfosten3.AddGeo(&m_zgPfosten);
	m_zpPfosten4.Translate(-5.0f, 0.15f, -5.0f);
	m_zpPfosten4.AddGeo(&m_zgPfosten);
	m_zpPfosten5.Translate(-0.1f, 0.15f, -5.0f);
	m_zpPfosten5.AddGeo(&m_zgPfosten);
	m_zpPfosten6.Translate(4.8f, 0.15f, -5.0f);
	m_zpPfosten6.AddGeo(&m_zgPfosten);
	m_zpPfosten7.Translate(4.8f, 0.15f, -0.1f);
	m_zpPfosten7.AddGeo(&m_zgPfosten);
	m_zpPfosten8.Translate(4.8f, 0.15f, 4.8f);
	m_zpPfosten8.AddGeo(&m_zgPfosten);
	m_zpPfosten9.Translate(1.4f, 0.15f, 4.8f);
	m_zpPfosten9.AddGeo(&m_zgPfosten);

	m_zpHintenUL.Translate(-4.8f, 0.55f, -4.95f);
	m_zpHintenUL.AddGeo(&m_zgBalkenLang);
	m_zpHintenOL.Translate(-4.8f, 0.95f, -4.95f);
	m_zpHintenOL.AddGeo(&m_zgBalkenLang);
	m_zpHintenUR.Translate(0.1f, 0.55f, -4.95f);
	m_zpHintenUR.AddGeo(&m_zgBalkenLang);
	m_zpHintenOR.Translate(0.1f, 0.95f, -4.95f);
	m_zpHintenOR.AddGeo(&m_zgBalkenLang);

	m_zpLinksUV.Translate(-4.8f, 0.55f, -4.95f);
	m_zpLinksUV.RotateYDelta(0.5*PI);
	m_zpLinksUV.AddGeo(&m_zgBalkenLang);
	m_zpLinksUH.Translate(0.1f, 0.55f, -4.95f);
	m_zpLinksUH.RotateYDelta(0.5*PI);
	m_zpLinksUH.AddGeo(&m_zgBalkenLang);
	m_zpLinksOV.Translate(-4.8f, 0.95f, -4.95f);
	m_zpLinksOV.RotateYDelta(0.5*PI);
	m_zpLinksOV.AddGeo(&m_zgBalkenLang);
	m_zpLinksOH.Translate(0.1f, 0.95f, -4.95f);
	m_zpLinksOH.RotateYDelta(0.5*PI);
	m_zpLinksOH.AddGeo(&m_zgBalkenLang);

	m_zpRechtsUV.Translate(-4.8f, 0.55f, -4.95f);
	m_zpRechtsUV.RotateYDelta(-0.5*PI);
	m_zpRechtsUV.AddGeo(&m_zgBalkenLang);
	m_zpRechtsUH.Translate(0.1f, 0.55f, -4.95f);
	m_zpRechtsUH.RotateYDelta(-0.5*PI);
	m_zpRechtsUH.AddGeo(&m_zgBalkenLang);
	m_zpRechtsOV.Translate(-4.8f, 0.95f, -4.95f);
	m_zpRechtsOV.RotateYDelta(-0.5*PI);
	m_zpRechtsOV.AddGeo(&m_zgBalkenLang);
	m_zpRechtsOH.Translate(0.1f, 0.95f, -4.95f);
	m_zpRechtsOH.RotateYDelta(-0.5*PI);
	m_zpRechtsOH.AddGeo(&m_zgBalkenLang);

	m_zpVorneUL.Translate(-4.8f, 0.55f, 4.85f);
	m_zpVorneUL.AddGeo(&m_zgBalkenKurz);
	m_zpVorneOL.Translate(-4.8f, 0.95f, 4.85f);
	m_zpVorneOL.AddGeo(&m_zgBalkenKurz);
	m_zpVorneUR.Translate(1.6f, 0.55f, 4.85f);
	m_zpVorneUR.AddGeo(&m_zgBalkenKurz);
	m_zpVorneOR.Translate(1.6f, 0.95f, 4.85f);
	m_zpVorneOR.AddGeo(&m_zgBalkenKurz);

	m_zpDrehelement.Translate(-1.4f, -4.95f, 0.8f);
	m_zpDrehelement.RotateXDelta(-0.5*PI);
	m_zpDrehelement.AddGeo(&m_zgDrehelement);

	m_zpSchranke.Translate(-0.7f, 1.36f, 4.875f);
