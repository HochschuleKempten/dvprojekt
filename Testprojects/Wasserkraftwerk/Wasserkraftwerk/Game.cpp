...
void CGame::Init(HWND hwnd, CSplash * psplash)
{
	...
	m_zphydroelectricpowerplant.getMainPlacement()->Translate(CHVector(2.0f, -2.0f, 3.0f));

	m_zs.AddPlacement(m_zphydroelectricpowerplant.getMainPlacement());
...
void CGame::Tick(float fTime, float fTimeDelta)
{
	...
	m_zphydroelectricpowerplant.rotate(fTimeDelta);
